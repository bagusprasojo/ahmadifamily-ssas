...
INSTALLED_APPS = [
    ...
    'treeapp',  # Your application for family tree management
]
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'templates'],  # cari template di folder global
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
# Tambahkan ini jika kamu punya folder static di luar app, misalnya sejajar dengan manage.py
STATICFILES_DIRS = [
    BASE_DIR / "static",
]
